package co.paulfran.paulfranco.currencyconverter;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void convert(View view) {
        ...
        Double poundAmount = dollarAmountDouble * 18.35;
        Toast.makeText(this, String.format("%.2f", poundAmount) + " Pesos", Toast.LENGTH_SHORT).show();
